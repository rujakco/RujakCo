...
export const FAQ_DATA = [
  ...
  { keywords: ["pedas", "level", "spice", "cabai", "asinan"], answer: "Level pedasnya bisa Kakak atur sendiri, dari Ringan sampai Neraka — sama seperti rujak. Defaultnya kami set di level Pedas (level 3), tapi bebas disesuaikan pas pesan." },
