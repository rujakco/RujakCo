...
export function initCartController(domConfig, appState) {
  DOM = domConfig;
  state = appState;
}
...
export function updateCartUI() {
  ...
  if (DOM.liveCartRegion) {
    DOM.liveCartRegion.textContent = totalItems > 0 ? `${totalItems} item di keranjang` : 'Keranjang kosong';
  }
